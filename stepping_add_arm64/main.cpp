...
int mnop(){
    ...
    asum_of_sep=(long double)sum_of_sep / (long double) 2;
    cout<< std::setprecision(preci) << sum_of_sep << " / " << std::setprecision(preci) <<  " 2 " << std::setprecision(preci) << " ::== " << asum_of_sep <<"\n";
